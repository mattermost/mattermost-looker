...
view: hacktoberboard_dev {
  ...
  measure: usessl_count {
    label: "Usessl Users"
    description: "The distinct count of Hacktoberboard Dev with Usessl marked true."
  ...
  measure: port_count {
    label: "Port Users"
    description: "The distinct count of Hacktoberboard Dev with Port marked true."
    group_label: "User Counts"
    type: count_distinct
  ...
  measure: serverroot_count {
    ...
    description: "The distinct count of Hacktoberboard Dev with Serverroot marked true."
    group_label: "User Counts"
    type: count_distinct
  ...
  measure: id_count {
    label: " Id Count"
    description: "The distinct count of Hacktoberboard Dev Id within each grouping."
    type: count_distinct
    sql: ${id} ;;
  }
