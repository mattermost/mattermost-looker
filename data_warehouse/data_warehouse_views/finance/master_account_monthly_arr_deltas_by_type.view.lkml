view: master_account_monthly_arr_deltas_by_type {
  ...
  measure: count_arr_new_accounts {
    label: "# of ARR New Master Accounts"
    type: count_distinct
  ...
  measure: count_arr_explansion_accounts {
    label: "# of ARR Explansion Master Accounts"
    type: count_distinct
  ...
  measure: count_arr_resurrection_accounts {
    label: "# of ARR Resurrection Master Accounts"
    type: count_distinct
  ...
  measure: count_arr_contraction_accounts {
    label: "# of ARR Contraction Master Accounts"
    type: count_distinct
  ...
  measure: count_arr_churn_accounts {
    label: "# of ARR Churn Master Accounts"
    type: count_distinct
