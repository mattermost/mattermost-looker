...
#     hidden: yes
  ...
  set: core_drill_fields {
    fields: [account.name, organization_name, assignee_name, ticket_id, support_type, e20_customer_level_tier, status, created_date, solved_at_date, calendar_days_open,
