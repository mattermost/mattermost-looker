...
view: CUSTOMERS {
  ...
  measure: id_count {
    label: " Id Count"
    description: "The distinct count of Customers Id within each grouping."
    type: count_distinct
    sql: ${id} ;;
  }
  ...
  measure: version_count {
    label: " Version Count"
    description: "The distinct count of Customers Versions within each grouping."
    type: count_distinct
    sql: ${version_id} ;;
  }
  ...
  measure: previous_version_count {
    ...
    description: "The distinct count of Customers Previous Versions within each grouping."
    type: count_distinct
  ...
  measure: stripe_count {
    label: " Stripe Count"
    description: "The distinct count of Customers Stripes within each grouping."
    type: count_distinct
    sql: ${stripe_id} ;;
  }
