...
view: SUBSCRIPTIONS {
  ...
  measure: id_count {
    label: " Id Count"
    description: "The distinct count of Subscriptions Id within each grouping."
    type: count_distinct
    sql: ${id} ;;
  }
  ...
  measure: product_count {
    label: " Product Count"
    description: "The distinct count of Subscriptions Products within each grouping."
    type: count_distinct
    sql: ${product_id} ;;
  }
  ...
  measure: customer_count {
    ...
    description: "The distinct count of Subscriptions Customers within each grouping."
    type: count_distinct
    sql: ${customer_id} ;;
  }

  measure: num_seats_sum {
    description: "The sum of Num Seats within each grouping."
    type: sum
  ...
  measure: num_seats_max {
    description: "The max Num Seats within each grouping."
    type: max
    group_label: "Num Seats Measures"
    sql: ${num_seats} ;;
  }
  ...
  measure: num_seats_min {
    description: "The min Num Seats within each grouping."
    type: min
    group_label: "Num Seats Measures"
    sql: ${num_seats} ;;
  }
  ...
  measure: num_seats_avg {
    description: "The average Num Seats within each grouping."
    type: average
    group_label: "Num Seats Measures"
    sql: ${num_seats} ;;
  }
  ...
  measure: num_seats_median {
    description: "The median  Num Seats within each grouping."
    type: median
    group_label: "Num Seats Measures"
    sql: ${num_seats} ;;
  }
  ...
  measure: stripe_count {
    label: " Stripe Count"
    description: "The distinct count of Subscriptions Stripes within each grouping."
    type: count_distinct
    sql: ${stripe_id} ;;
  }
  ...
  measure: cloud_installation_count {
    ...
    description: "The distinct count of Subscriptions Cloud Installations within each grouping."
    type: count_distinct
    sql: ${cloud_installation_id} ;;
  }

  measure: runrate_max {
    description: "The max Runrates within each grouping."
    type: max
  ...
  measure: runrate_min {
    description: "The min Runrates within each grouping."
    type: min
    group_label: "Runrate Measures"
    sql: ${runrate} ;;
  }
  ...
  measure: runrate_avg {
    description: "The average Runrates within each grouping."
    type: average
    group_label: "Runrate Measures"
    sql: ${runrate} ;;
  }
  ...
  measure: runrate_median {
    description: "The median  Runrates within each grouping."
    type: median
    group_label: "Runrate Measures"
    sql: ${runrate} ;;
  }
