...
view: FEATURES {
  ...
  measure: id_count {
    label: " Id Count"
    description: "The distinct count of Feature Id's within each grouping."
    type: count_distinct
    sql: ${id} ;;
  }
  ...
  measure: version_count {
    label: " Version Count"
    description: "The distinct count of Features Version Id's within each grouping."
    type: count_distinct
    sql: ${version_id} ;;
  }
  ...
  measure: previous_version_count {
    ...
    description: "The distinct count of Features Previous Version Id's within each grouping."
    type: count_distinct
