...
view: PURCHASE_FACT {
  ...
  measure: customer_stripe_count {
    ...
    description: "The distinct count of Purchase Fact Customer Stripes within each grouping."
    type: count_distinct
  ...
  measure: subscription_stripe_count {
    ...
    description: "The distinct count of Purchase Fact Subscription Stripes within each grouping."
    type: count_distinct
  ...
  measure: payment_stripe_count {
    ...
    description: "The distinct count of Purchase Fact Payment Stripes within each grouping."
    type: count_distinct
  ...
  measure: payment_method_stripe_count {
    ...
    description: "The distinct count of Purchase Fact Payment Method Stripes within each grouping."
    type: count_distinct
  ...
  measure: charge_stripe_count {
    ...
    description: "The distinct count of Purchase Fact Charge Stripes within each grouping."
    type: count_distinct
  ...
  measure: product_stripe_count {
    ...
    description: "The distinct count of Purchase Fact Product Stripes within each grouping."
    type: count_distinct
  ...
  measure: has_premier_support_count {
    ...
    description: "The distinct count of Purchase Fact with Has Premier Support marked true."
    group_label: "User Counts"
    type: count_distinct
    sql: case when ${has_premier_support} then ${id} else null end ;;
  }
  ...
  measure: installation_count {
    ...
    description: "The distinct count of Purchase Fact Installations within each grouping."
    type: count_distinct
    sql: ${installation_id} ;;
  }
