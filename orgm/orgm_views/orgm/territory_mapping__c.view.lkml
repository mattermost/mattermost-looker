  view: territory_mapping__c {
  sql_table_name: orgm.territory_mapping__c ;;
  view_label: ""

  drill_fields: [sfid, name, country_name__c, state_name__c, geo__c, territory__c, region__c, domain__c]
  ...
  dimension: enterprise_rep__c {
    type: string
    sql: ${TABLE}."enterprise_rep__c" ;;
    label: "Enterprise Rep"
    group_label: "Sales Org"
  }
